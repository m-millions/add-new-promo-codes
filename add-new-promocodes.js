...
if (process.argv.length != 11){
    console.log("usage: node add-promo-codes.js num_codes \
                        promotion_id start end unlimited");
    return;
}
...
// causes a false error "Error on save!MongoError: server localhost:27017
// sockets closed" - but still saves record to the collection.
